    ...
    <div className="relative py-4 px-6 md:px-8 bg-white">
      <div className="flex flex-col md:flex-row items-start gap-6">
        <img
          ...
          alt=""
          className="absolute -top-10 border-4 border-white w-30 h-30 shadow-xl rounded-full z-2"
        />
      </div>
      <div className="w-full pt-16 md:pt-0 md:pl-36">
            ...
            <button
              ...
              flex items-center
               gap-2 text-sm cursor-pointer
                border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0"
            >
        ...
        >
          ...
          <div>
            ...
            <span
              className="text-xs
             sm:text-sm text-gray-500 ml-1.5"
            >
              Following
            </span>
          </div>
