...
import { Image, Send, SendHorizonal, SendHorizontal } from "lucide-react";
      ...
      <div className="flex flex-col h-screen">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray -mt-1.5">@{user.username}</p>
          </div>
        </div>
          ...
          >
            ...
            <label htmlFor="image">
              {image ? (
                ...
                <Image className="size-7 cursor-pointer  text-gray-400" />
              )}
              <input
                type="file"
                id="image"
